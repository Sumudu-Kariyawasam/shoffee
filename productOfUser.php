...
<body class="admin_bg text-white overflow-hidden" onload="adminUserProducts('1','all');">
                                    ...
                                    <div class="col-12 mb-2 dash_border rounded bg-dark shadow_nav overflow-hidden admin-mng-prod1">
                                        <div class="row p-3 pb-0">
                                            <ul class="nav nav-tabs">
                                                <li class=" nav-item pointer" onclick="userProdChange('all');">
                                                    <a class="nav-link nav2 active" id="Ptab1">All Listings</a>
                                                </li>
                                                <li class=" nav-item pointer" onclick="userProdChange('act');">
                                                    <a class="nav-link nav2" id="Ptab2">Active</a>
                                                </li>
                                                <li class=" nav-item pointer" onclick="userProdChange('dct');">
                                                    <a class="nav-link nav2" id="Ptab3">Deactive</a>
                                                </li>
                                                <li class=" nav-item pointer" onclick="userProdChange('dlt');">
                                                    <a class="nav-link nav2" id="Ptab4">Deleted</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row p-3 pt-0">
                                                ...
                                                <div class="collapse filters-b" id="collapse2">
                                                    <div class="col-12 pt-3 pb-lg-2">
                                                        <div class="row">
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <select id="sltd_usr_sbc" class=" form-infield3 bg-dark">
                                                            ...
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <select id="sltd_usr_brd" class=" form-infield3 bg-dark">
                                                            ...
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <select id="sltd_usr_mdl" class=" form-infield3 bg-dark">
                                                    ...
                                                    <div class="col-12 pb-0 pb-lg-2">
                                                        <div class="row">
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <select id="sltd_usr_con" class=" form-infield3 bg-dark">
                                                            ...
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <input placeholder="Price From" class="form-infield3 px-3" id="sltd_usr_prf">
                                                                </div>
                                                            </div>
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <input placeholder="Price To" class="form-infield3 px-3" id="sltd_usr_prt">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-lg-7">
                                                                <div class="row ps-2 pe-2 pe-lg-1">
                                                                    <input placeholder="Search Here" class="form-infield4 px-3" id="sltd_usr_txt">
                                                                </div>
                                                            </div>
                                                            <div class="col-6 col-lg-3">
                                                                <div class="row px-2">
                                                                    <select type="text" class="form-infield4 bg-dark" id="sltd_usr_time">
                                                            ...
                                                            <div class="col-6 col-lg-2">
                                                                <div class="row ps-1 pe-2">
                                                                    <button type="" id="" class="btn-6" onclick="adminUserProducts('1','get');">Search</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <input type="text" class=" d-none" id="sltd_usr_eml" value="<?php echo $usrmail; ?>">
                                                ...
                                                <div class="col-12 overflow-y admin-mng-prod2" id="ad_usr_pro_view">
                                                </div>
                                            </div>
                                        </div>
...
<div class="col-12 vh-100 d-flex justify-content-center align-items-center">
    <div class="row">
        <p class=" fs-6 fw-bold">Oops.! Something is missing..</p>
    </div>
</div>
