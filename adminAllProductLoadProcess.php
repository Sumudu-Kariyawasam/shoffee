...
if($type == "all"){
    $quary.=" WHERE product.status <= 3";
}else if($type == "act"){
    $quary.=" WHERE product.status = 1";
}else if($type == "dct"){
    $quary.=" WHERE product.status = 2";
}else if($type == "dlt"){
    $quary.=" WHERE product.status = 3";
}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <button class="btn-1 text-white" onclick="window.location = '<?php echo ('updateProduct.php?id=' . $prod_data['product_id']); ?>'" style="background-color: #ffc61c;" <?php if ($prod_data["status"] == 3) {
                                                                                                                                                                                                                        echo "disabled";
                                                                                                                                                                                                                    } ?>>Edit</button>
                                </div>
                                <div class="col-4">
