                                    ...
                                    <div class="row p-3">
                                        ...
                                        <div class="col-6">
                                            <div class="row pe-1">
                                                ...
                                                <input type="text" id="" class=" form-infield" value="<?php echo ($user["fname"]); ?>">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="row ps-1">
                                                <label class="fw-bold">Last Name</label>
                                                <input type="text" id="" class=" form-infield" value="<?php echo ($user["lname"]); ?>">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">
                                                <label class="fw-bold">Email Address</label>
                                                <input type="text" id="" class=" form-infield" value="<?php echo ($email); ?>">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="row pe-1">
                                                <label class="fw-bold">Mobile</label>
                                                <input type="text" id="" class=" form-infield" value="<?php echo ($user["mobile"]); ?>">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="row ps-1">
                                                <label class="fw-bold">Office</label>
                                                <input type="text" id="" class=" form-infield" value="<?php if(isset($user["office"])){ echo ($user["office"]); } ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row pe-1">
                        <div class="col-12 border border-dark border-opacity-50 rounded">
                            <div class="row p-4">
                                ...
                                if ($num > 0) {
                                    for ($x = 0; $x < $num; $x++) {
                                        $product_rs = Database::search("SELECT * FROM `product` WHERE `product_id`='" . $_POST["product" . $x] . "'");
                                            ...
                                            <div class="row">
                                                <div class="col-12 border-bottom border-secondary border-opacity-25">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-6">
                                                            <span class="card-text text-success fw-bold" id="cqty"><?php echo ($qtt); ?> item(s)</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <input class="d-none col-1" name="total" value="<?php echo (($total + $tax) - $discount); ?>">
                                        <input class="d-none col-1" name="cart_num" value="<?php echo ($cart_num); ?>">
                                    </div>
                                </div>
                                <hr>
