...
<body class="admin_bg text-white overflow-hidden" onload="adminAllProducts('1','all');">
                    ...
                    <div class="col-10 col-lg-3 bg-dark position-absolute shadow_nav admin_nav nav_close" id="nav_menu_box">
                        <div class="row">
                            ...
                            <div class="col-12 p-0 mt-3">
                                ...
                                <div class="col-11 offset-1 mt-2 pointer active_nav" onclick="window.location = 'manageProducts.php'">
                                    <div class="row py-2 ps-3">
                                    ...
                                    <div class="col-12 mb-2 dash_border rounded bg-dark shadow_nav overflow-hidden admin-mng-prod1">
                                        <div class="row p-3 pb-0">
                                            <ul class="nav nav-tabs">
                                                <li class=" nav-item pointer" onclick="AdminProdChange('all');">
                                                    <a class="nav-link nav2 active" id="tab1">All Listings</a>
                                                </li>
                                                <li class=" nav-item pointer" onclick="AdminProdChange('act');">
                                                    <a class="nav-link nav2" id="tab2">Active</a>
                                                </li>
                                                <li class=" nav-item pointer" onclick="AdminProdChange('dct');">
                                                    <a class="nav-link nav2" id="tab3">Deactive</a>
                                                </li>
                                                <li class=" nav-item pointer" onclick="AdminProdChange('dlt');">
                                                    <a class="nav-link nav2" id="tab4">Deleted</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row p-3 pt-0">
                                                ...
                                                <div class="collapse filters-b" id="collapse2">
                                                    <div class="col-12 pt-3 pb-lg-2">
                                                        <div class="row">
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <select id="adm_all_sbc" class=" form-infield3 bg-dark">
                                                            ...
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <select id="adm_all_brd" class=" form-infield3 bg-dark">
                                                            ...
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <select id="adm_all_mdl" class=" form-infield3 bg-dark">
                                                    ...
                                                    <div class="col-12 pb-0 pb-lg-2">
                                                        <div class="row">
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <select id="adm_all_con" class=" form-infield3 bg-dark">
                                                            ...
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <input placeholder="Price From" class="form-infield3 px-3" id="adm_all_prf">
                                                                </div>
                                                            </div>
                                                            <div class="col-12 col-md-4">
                                                                <div class="row px-2">
                                                                    <input placeholder="Price To" class="form-infield3 px-3" id="adm_all_prt">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-lg-7">
                                                                <div class="row ps-2 pe-2 pe-lg-1">
                                                                    <input placeholder="Search Here" class="form-infield4 px-3" id="adm_all_txt">
                                                                </div>
                                                            </div>
                                                            <div class="col-6 col-lg-3">
                                                                <div class="row px-2">
                                                                    <select type="text" class="form-infield4 bg-dark" id="ad_sort_time">
                                                            ...
                                                            <div class="col-6 col-lg-2">
                                                                <div class="row ps-1 pe-2">
                                                                    <button type="" id="" class="btn-6" onclick="adminAllProducts('1','get');">Search</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12 overflow-y admin-mng-prod2" id="ad_all_pro_view">
                                                </div>
                                            </div>
                                        </div>
